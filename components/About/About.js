              ...
              <div className={classes.reward}>
                ...
                <div className={classes.item}>
                  <div>
                    ...
                    <Typography component="p" className={text.paragraph}>20 plus</Typography>
                ...
                <div className={classes.item}>
                  <div>
                    ...
                    <Typography component="p" className={text.paragraph}>Entrepreneurship</Typography>
                    <Typography variant="h5">Stratups</Typography>
                  </div>
                </div>
              </div>
              {!isTablet && (
